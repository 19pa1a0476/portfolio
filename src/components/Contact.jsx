  ...
  const handleSubmit = (e) => {
    ...
    emailjs
        ...
        "template_y98d25f",
      {
        ...
        // If your template uses `to_name` and `to_email`, include those as needed
        to_name: "Shyam Chandra Reddy Kethu",
        to_email: "kethu.shyam@gmail.com"
      },
        "4sIRemC6lZ1V9KbbH"
      )
      .then(
        ...
        >
          ...
          <div className="connect-me flex flex-col md:flex-row justify-around md:justify-around items-center">
            ...
            <button
              type='button'
              className='bg-tertiary py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary my-2'
              onClick={() => window.open('https://github.com/19pa1a0476', '_blank')}
            >GitHub
            </button>
